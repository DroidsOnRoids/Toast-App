...
class NotificationManager @Inject constructor(
    ...
    private val isNotificationsEnabled
        get() = sharedPrefs.getBoolean(context.getString(R.string.pref_key_all_notifications), true)
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences?, key: String) {
        if (key == context.getString(R.string.pref_key_all_notifications)) {
            refreshSubscriptions()
        } else {
    ...
    private fun isNotificationForTopicEnabled(key: String) =
            isNotificationsEnabled && sharedPrefs.getBoolean(key, true)
